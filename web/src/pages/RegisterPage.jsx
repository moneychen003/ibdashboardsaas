  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f8f9fa] px-4">
      <div className="w-full max-w-md rounded-2xl border border-[var(--light-gray)] bg-white p-8 shadow-sm">
        ...
        <p className="mb-6 text-sm text-[var(--gray)]">注册后即可上传 IBKR XML 并查看持仓成本</p>
        {error && (
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-[var(--gray)]">用户名</label>
            <input
              type="text"
              required
              value={username}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-[var(--gray)]">邮箱</label>
            <input
              type="email"
              required
              value={email}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-[var(--gray)]">确认密码</label>
            <input
              type="password"
              required
              minLength={6}
